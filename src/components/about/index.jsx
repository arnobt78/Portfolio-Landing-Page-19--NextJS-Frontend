...
// Optional .env override; when unset we use these public URLs (no API key). StatsImage shows placeholder on 503/fail.
...
// About section (Server Component): bio, stats, GitHub cards; StatsImage is client-only for fallback
const AboutDetails = () => {
  return (
